...
namespace Spine
{
	public class SkeletonBinary
	{
		...
		public SkeletonData ReadSkeletonData(Stream input)
		{
			...
			int m = 0;
			for (int num6 = ReadVarint(input, true); m < num6; m++)
			{
				...
				int n = 0;
				for (int num7 = ReadVarint(input, true); n < num7; n++)
				{
			...
			int num8 = 0;
			for (int num9 = ReadVarint(input, true); num8 < num9; num8++)
			{
			...
			int num12 = 0;
			for (int num13 = ReadVarint(input, true); num12 < num13; num12++)
			{
			...
			linkedMeshes.Clear();
			int num15 = 0;
			for (int num16 = ReadVarint(input, true); num15 < num16; num15++)
			{
		...
		private Attachment ReadAttachment(Stream input, Skin skin, int slotIndex, string attachmentName, bool nonessential)
		{
			...
			{
				int num8 = ReadVarint(input, true);
		...
		private void ReadAnimation(string name, Stream input, SkeletonData skeletonData)
		{
			...
			int num14 = 0;
			for (int num15 = ReadVarint(input, true); num14 < num15; num14++)
			{
			...
			int num22 = 0;
			for (int num23 = ReadVarint(input, true); num22 < num23; num22++)
			{
				int num24 = ReadVarint(input, true);
				...
				for (int num26 = ReadVarint(input, true); num25 < num26; num25++)
				{
					...
					int num28 = ReadVarint(input, true);
					switch (num27)
					{
					case 0:
					case 1:
			...
			int num32 = 0;
			for (int num33 = ReadVarint(input, true); num32 < num33; num32++)
			{
				Skin skin = skeletonData.skins.Items[ReadVarint(input, true)];
				int num34 = 0;
				for (int num35 = ReadVarint(input, true); num34 < num35; num34++)
				{
					int slotIndex2 = ReadVarint(input, true);
					int num36 = 0;
					for (int num37 = ReadVarint(input, true); num36 < num37; num36++)
					{
						...
						int num39 = ReadVarint(input, true);
			...
			if (num47 > 0)
			{
				...
				for (int num48 = 0; num48 < num47; num48++)
				{
					...
					int num49 = ReadVarint(input, true);
					...
					{
						int num54 = ReadVarint(input, true);
						while (num51 != num54)
						{
							array3[num52++] = num51++;
						}
						array2[num51 + ReadVarint(input, true)] = num51++;
					}
					while (num51 < count)
					{
						array3[num52++] = num51++;
			...
			int num56 = ReadVarint(input, true);
			if (num56 > 0)
			{
				...
				for (int num57 = 0; num57 < num56; num57++)
				{
					...
					eventTimeline.SetFrame(num57, @event);
				}
